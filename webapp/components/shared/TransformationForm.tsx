...
const TransformationForm = ({
  ...
  /**
   * In case of restore or remove background, we want the transformation happens right away
   * Apply Transformation Button can be clicked right away, since these 2 operations,
   * do not need any more form inputs, like other transformation types.
   */
  useEffect(() => {
